...
if (isset($_GET['download']) && $_GET['download'] === 'csv') {
    // 查詢資料
    $query = "SELECT supplier_id, name, contact_info, address 
              FROM suppliers";
    ...
    header('Content-Disposition: attachment; filename=supplier_data_report.csv');
...
<body>
    <h1>供應商資料報表</h1>
    <!-- CSV 下載鏈接 -->
    <a href="supplier_data_report.php?download=csv" class="download-link">下載 CSV</a>
